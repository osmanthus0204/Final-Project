...
HD_PWD='D:/work_2/FPGA_Harman_Final_Project/250727_ov7670_z720/250727_ov7670_z720.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7640_HDMI_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV7640_HDMI_Display.tcl

...
HD_PWD='D:/work_2/FPGA_Harman_Final_Project/250727_ov7670_z720/250727_ov7670_z720.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7640_HDMI_Display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OV7640_HDMI_Display.tcl -notrace

...
module OV7670_MemController (
    ...
    output logic [ 9:0] h_counter_o,
    output logic [ 7:0] v_counter_o,
    output logic        we,
    ...
    assign h_counter_o = h_counter;
    assign v_counter_o = v_counter;


    assign wAddr = v_counter[7:1] * 160 + h_counter[9:2]; // h_counter/4 = h_counter[9:2]

...
../Core/ap/Presenter/Presenter_KeyBoard.c \
../Core/ap/Presenter/Presenter_ServoMotor.c 

OBJS += \
./Core/ap/Presenter/Presenter.o \
./Core/ap/Presenter/Presenter_KeyBoard.o \
./Core/ap/Presenter/Presenter_ServoMotor.o 

C_DEPS += \
./Core/ap/Presenter/Presenter.d \
./Core/ap/Presenter/Presenter_KeyBoard.d \
./Core/ap/Presenter/Presenter_ServoMotor.d 
...
clean-Core-2f-ap-2f-Presenter:
	-$(RM) ./Core/ap/Presenter/Presenter.cyclo ./Core/ap/Presenter/Presenter.d ./Core/ap/Presenter/Presenter.o ./Core/ap/Presenter/Presenter.su ./Core/ap/Presenter/Presenter_KeyBoard.cyclo ./Core/ap/Presenter/Presenter_KeyBoard.d ./Core/ap/Presenter/Presenter_KeyBoard.o ./Core/ap/Presenter/Presenter_KeyBoard.su ./Core/ap/Presenter/Presenter_ServoMotor.cyclo ./Core/ap/Presenter/Presenter_ServoMotor.d ./Core/ap/Presenter/Presenter_ServoMotor.o ./Core/ap/Presenter/Presenter_ServoMotor.su
